        ...
        <div className="relative flex flex-col items-center md:w-1/2 p-8 md:p-10 ">
          ...
          <div className="w-full mt-4">
            ...
            <input
              ...
              className="border border-gray-200 rounded w-full px-2.5 mt-1 outline-indigo-500 font-light "
              required
            />
          </div>
          <div className="w-full mt-4">
          ...
          <button className="bg-indigo-500 hover:bg-indigo-600 transform-all text-white mr-auto px-2 py-2 rounded cursor-pointer mt-6">
            Register
          </button>
        </div>
      </form>
